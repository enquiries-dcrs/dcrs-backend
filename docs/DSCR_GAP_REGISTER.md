...
| DSCR-C1-05 | **1 — Inclusive care planning…** | Involving individuals in their own care planning process. | **Evidence:** `appMode` + `/family` UI shell. **Gap:** **Not production** — mock feed, no authenticated individual access to real plans / co-production workflow. | Crit | Y | Y | MVP |
...
| DSCR-C4-01 | **4 — Controlled access to data** | Access for individuals to view their own care plans/records. | **Evidence:** None production. **Gap:** Same as C1-05 — family/individual path not backed by scoped APIs and real data. | Crit | Y | Y | MVP |
...
| DSCR-C6-04 | **6 — Operation…** | Providing reports that support meeting the "Key Lines of Enquiry" of the CQC inspection regime. | **Evidence:** Operational checklist doc + partial exports. **Gap:** No **KLOE-mapped** report pack in product. | High | N | Y | 1.0 |
